...
output_shp = "before_points_class70.shp"  # Output shapefile for sampled points
...
gdf = gpd.GeoDataFrame(
    {"value": [70] * len(sample_coords)},  # Assign a value of 80 to all points
