...
output_path = os.path.join(output_directory, "MOYD21A1DN_2016-2020_2000-2005_Average.tif")

# File paths for the four images
image_paths = [
    os.path.join(input_directory, "MOD21A1D_2016-2020_2000-2005_mean_difference.tif"),
    os.path.join(input_directory, "MOD21A1N_2016-2020_2000-2005_mean_difference.tif"),
    os.path.join(input_directory, "MYD21A1D_2016-2020_2000-2005_mean_difference.tif"),
    os.path.join(input_directory, "MYD21A1N_2016-2020_2000-2005_mean_difference.tif")
]
