...
output_path = os.path.join(output_directory, "MOYD21A1DN_2000-2000_mean_Average.tif")

# File paths for the four images
image_paths = [
    os.path.join(input_directory, "MOD21A1D_Global_2000-2020_1000m_vat45_LSTday_mean_mosaic.tif"),
    os.path.join(input_directory, "MOD21A1N_Global_2000-2020_1000m_vat45_LSTday_mean_mosaic.tif"),
    os.path.join(input_directory, "MYD21A1D_Global_2000-2020_1000m_vat45_LSTday_mean_mosaic.tif"),
    os.path.join(input_directory, "MYD21A1N_Global_2000-2020_1000m_vat45_LSTday_mean_mosaic.tif")
]
