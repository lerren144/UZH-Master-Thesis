...
output_path = os.path.join(output_directory, "MOYD21A1DN_2000-2000_mean_RegressCombination.tif")

# File paths for the four images
Tday_image = os.path.join(input_directory, "MOD21A1D_Global_2000-2020_1000m_vat45_LSTday_mean_mosaic.tif")
Tnight_image = os.path.join(input_directory, "MOD21A1N_Global_2000-2020_1000m_vat45_LSTday_mean_mosaic.tif")
Aday_image = os.path.join(input_directory, "MYD21A1D_Global_2000-2020_1000m_vat45_LSTday_mean_mosaic.tif")
Anight_image = os.path.join(input_directory, "MYD21A1N_Global_2000-2020_1000m_vat45_LSTday_mean_mosaic.tif")
