...
binary_tif_path = r'C:\Users\llccl\OneDrive\Documents\To Do\Academics\2nd Year - 1st Semester\Master Thesis\2 - Thesis Proper\5 - Processing\Thesis New\Disturbed Mask\2000 to 2020 Exports\Copernicus LC\Undisturbed_Mask_Changes\undisturbed_mask.tif'
value_tif_path = r'C:\Users\llccl\OneDrive\Documents\To Do\Academics\2nd Year - 1st Semester\Master Thesis\2 - Thesis Proper\5 - Processing\Thesis New\LC_LST_Results\Compiled_Average_Combination\MOYD21A1DN_2000-2000_LinearTrend_RegressCombination.tif'
...
# Divide all values and statistics by 100
plot_values = plot_values / 100
q1, q3 = q1 / 100, q3 / 100
median = np.median(plot_values)
mean = np.mean(plot_values)
gdal_min, gdal_max = gdal_min / 100, gdal_max / 100
